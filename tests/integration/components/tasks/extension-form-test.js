...
module.only(
  'Integration | Component | Extension Request Form',
  function (hooks) {
    ...
    test('When Clicked /"Close Form/" button or background task extension form should unmount', async function (assert) {
      ...
      await click(
        this.element.querySelector('.extension-form__container-close')
      );
      assert
        .dom(this.element.querySelector('[data-test-title]'))
        .doesNotExist();
      ...
      assert
        ...
        .hasText('Form for extension Request');
      await click(
        this.element.querySelector('.extension-form__container-back')
      );
      assert
        .dom(this.element.querySelector('[data-test-title]'))
        .doesNotExist();
